...
В документе представлены официальные версии продуктов Apache в версии **ADS 1.6.0.0**, дано описание новой функциональности компонентов и известных проблем.
...
+ Сервисное действие *Check* также производит проверку сервисов с помощью утилиты *systemctl*.
