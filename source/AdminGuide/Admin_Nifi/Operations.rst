...
1. Выбрать действие *Shrink* cервиса *Nifi* из списка возможных операций (см. :numref:`Рис.%s <nifi_operations_nifi_action>`), что приводит к появлению окна распределения компонента по хостам (см. :numref:`Рис.%s <nifi_operations_expand_nifi_hc_menu>`);
