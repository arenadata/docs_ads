...
Для установки всех добаленных сервисов в кластере *ads* необходимо выбрать соответствующий кластер в ADCM и нажать кнопку Install в правом вехнем углу


cluster_install.png


По результатам установки все добавленные сервисы меняют состояние с created -– создан, на installed -– установлен.
