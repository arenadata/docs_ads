...
#. Создать хосты для кластера ADS:
   ...
   * Инициализировать необходимое количество хостов (в текущем примере используется 4 хоста): для Zookeeper (*zk*), для Kafka брокеров (*kafka1* и *kafka2*), для Nifi (*nifi*);
