...
Самым простым вариантом установки кластера ADB является использование Arenadata Cluster Manager
...
#. Создать хосты для кластера ADS:
   ...
   * Инициализировать необходимое количество хостов (в текущем примере используется 4 хоста): для Zookeeper (*df-zk*), для Kafka брокеров (*df-kafka1* и *df-kafka2*), для Nifi (*df-nifi*);
