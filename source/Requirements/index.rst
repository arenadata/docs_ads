...
В требованиях приведены необходимые сведения для подготовки к установке кластера Arenadata Streaming, в том числе рассматриваются различные способы установки:
