...
В платформе **ADS** связь между клиентами и серверами осуществляется с помощью протокола **TCP**. **Arenadata** предоставляет Java-клиент для **ADS**, при этом клиенты доступны на многих языках программирования (`Clients <https://cwiki.apache.org/confluence/display/KAFKA/Clients>`_).

Сервис **NiFi** в составе платформы **ADS** поддерживает мощные и масштабируемые графики маршрутизации данных, их преобразования и логики системной медиации. Некоторые из высокоуровневых возможностей и целей **NiFi**:

+ Веб-интерфейс пользователя

  + Бесшовный опыт между дизайном, управлением, обратной связью и мониторингом

+ Высокая настраиваемость 

  + Толерантность по отношению к гарантированной доставке
  + Низкая латентность по отношению к высокой пропускной способности
...
+ Безопасность
  ...
  + Мультитенантная авторизация и внутренняя авторизация/управление политикой
