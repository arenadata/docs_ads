...
В документации приведены настройки платформы Arenadata Streaming на уровне брокера и топика, а также конфигурирование Producer, Consumer, Connect, Streams и настройки сервисов посредством ADCM.
