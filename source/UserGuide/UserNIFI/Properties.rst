...
Сведения об управлении привилегиями компонентов приведены в разделе `Политики доступа <../../AdminGuide/Admin_Nifi/Policies>`_ документа `Руководство администратора по работе с сервисом Nifi <../../AdminGuide/Admin_Nifi/index>`_.
